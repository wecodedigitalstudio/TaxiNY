...
using TaxiNYML.Model;

namespace TaxiNYML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Giorgio Della Roscia\Desktop\Andamento latte\TaxiNY\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../TaxiNYML.Model/MLModel.zip";
